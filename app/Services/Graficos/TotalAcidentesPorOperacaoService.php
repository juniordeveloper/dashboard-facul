...
use App\Services\Graficos\Contracts\TotalAcidentesPorOperacaoServiceInterface;
use Illuminate\Support\Facades\Cache;

class TotalAcidentesPorOperacaoService implements TotalAcidentesPorOperacaoServiceInterface
{
    ...
    public function handler()
    {
        ...
        $rows = $rows
            ->filter(function ($item) {
                return !empty($item['fase-de-operacao-da-aeronave']);
            })
            ->filter(function ($item) {
            ...
            ->map(function ($item) {
                return [
                    ...
                    'fase-de-operacao-da-aeronave' => $item['fase-de-operacao-da-aeronave'],
                ];
            })
            ->groupBy('fase-de-operacao-da-aeronave');
