...
use App\Services\Graficos\Contracts\MidiaSocialServiceInterface;
use Illuminate\Support\Facades\Cache;

class MidiaSocialService implements MidiaSocialServiceInterface
{
    ...
    public function handler($dadoAlunoGeral, $dadoDocente, $dadoFuncionario)
    {
        ...
        $perguntaSexo = $dadoAlunoGeral->filter(function ($i) {
            return in_array($i->numero_pergunta, ['67']);
        });
        $dataSexo = [
            'label' => [],
            'series' => [],
