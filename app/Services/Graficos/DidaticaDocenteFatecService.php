...
use App\Services\Graficos\Contracts\DidaticaDocenteFatecServiceInterface;

class DidaticaDocenteFatecService implements DidaticaDocenteFatecServiceInterface
{
    ...
    public function handler($dadoAlunoGeral, $dadoDocente, $dadoFuncionario)
    {
        ...
        $perguntaSexo = $dadoAlunoGeral->filter(function ($i) {
            return in_array($i->numero_pergunta, ['37']);
        });
        $dataSexo = [
            'label' => [],
            'series' => [],
